...
**Last ned-konvensjon:** Bilder skal lastes ned lokalt under `raw/assets/snl/<slug>.jpg` med beskrivende filnavn. Bruk Obsidians `![[filnavn.jpg|<bredde>]]`-wikilink-syntaks for embed. Hot-linking unngås, siden SNL kan endre URL-er og lokal lagring sikrer vault-portabilitet.
...
Bredere bruksmønster av SNL-API for andre vault-områder dokumentert i [[meta/ideas/SNL API integrasjon]].
...
4. **Log:** legg én linje i `wiki/log.md` etter vanlig log-konvensjon: `## [YYYY-MM-DD] dikt-analyse | <dikt-tittel>`.
